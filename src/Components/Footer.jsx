  ...
  return (
    <>
      <div className="contact">
        <p>
          ONLINE SHOPPING SITE FOR INDIAN ETHNIC AND FASHION WEAR CLOTHING –
          ARAV ETHNICS
        </p>
        <h5>
        ...
        <div className="contactDetails">
          <h5>
            Feel free to drop us a message at<br></br>
            <strong> email 📧 contact@aravethnics.com .</strong>
            <br></br>
            <br></br>
            For Business enquiries<br></br>
            <strong>
              {" "}
              please Call 📞 /{" "}
              <svg
              ...
              WhatsApp us @ +91-6299986646{" "}
            </strong>
            <br></br>
            <br></br>
            Customer Care :-
            <strong> +91-6299986646 / 9am-5pm</strong>
          </h5>
          │<br></br>│<br></br>│<br></br>│<br></br>│<br></br>│<br></br>│<br></br>
          <div className="ggform">
            <h4> Fill Up the google form</h4>
            <h4>gdnjzdjf aj fvjkz djv ajd j</h4>
          </div>
        </div>
